...
<svelte:head>
  ...
  <meta name="description" content="Affordable IT support for small businesses. For just $400/month, get secure, reliable IT management without the enterprise price tag. No contracts, no surprises." />
</svelte:head>
