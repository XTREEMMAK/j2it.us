	...
	const services = [
		{
			...
			description:
				'Proactive monitoring and management of your IT infrastructure to prevent problems before they impact your business.',
			features: [
		...
		},
		{
			...
			description:
				'Protect your business with enterprise-grade security solutions that fit your budget and compliance requirements.',
			features: [
		...
		},
		{
			...
			description:
				'Secure, automated backup solutions with fast recovery options to ensure your critical data is always protected.',
			features: [
			...
			disclaimer:
				'Backup pricing depends on the solution and data volume per endpoint. We’ll provide clear, upfront pricing before setup so you always know what you’ll pay, with no surprises.'
		},
		{
			icon: 'heroicons:cog-6-tooth',
			title: 'System Maintenance',
			description:
				'Regular updates, patches, and maintenance to keep your systems running smoothly and securely.',
			features: [
				'Software updates',
				'Security patches',
...
<svelte:head>
	...
	<meta
		name="description"
		content="Comprehensive IT services for small businesses. Managed IT support, security, data backup, and system maintenance. Flat-rate pricing, no surprises."
	/>
</svelte:head>
...
{#if mounted}
	<div class="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
		...
		<div class="fixed inset-0 overflow-hidden pointer-events-none">
			<div
				class="absolute top-1/3 left-1/4 w-96 h-96 bg-gradient-radial from-[#4dd36f]/5 to-transparent rounded-full blur-3xl"
			></div>
			<div
				class="absolute bottom-1/3 right-1/4 w-96 h-96 bg-gradient-radial from-[#4dd3ff]/5 to-transparent rounded-full blur-3xl"
			></div>
		</div>
		...
		<div class="relative z-10 max-w-6xl mx-auto">
			...
			<div class="text-center mb-16" in:fly={{ y: 20, duration: 600 }}>
				...
				<p class="text-2xl text-white/70 max-w-3xl mx-auto">
					Everything you need to keep your technology running smoothly, securely, and reliably. One
			...
			<!-- Pricing Section -->
			<div
				class="bg-[#1a1a2e] rounded-2xl p-8 text-center mb-16"
