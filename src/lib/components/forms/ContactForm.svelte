    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.message ? 'border-red-500' : 'border-white/20'} text-white placeholder-white/50 focus:border-[#4dd3ff] focus:bg-white/8 transition-all resize-vertical"
          placeholder={showBusinessFields ? "Tell me about your current IT challenges or what you'd like help with..." : "Tell me how I can help you..."}
        ></textarea>
        {#if errors.message}
