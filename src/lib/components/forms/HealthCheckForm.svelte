...
{#if mounted}
  <div class="max-w-4xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-4">
        {#each benefits as benefit, i}
          <div class="flex items-start gap-3">
            <div class="w-6 h-6 rounded-full bg-gradient-to-r from-[#4dd3ff] to-[#4dd36f] flex items-center justify-center flex-shrink-0 mt-0.5">
    ...
    <div class="bg-[#1a1a2e] rounded-2xl p-8 shadow-2xl">
      <h3 class="text-2xl font-bold mb-6 text-center gradient-text">Get Your Free IT Health Check</h3>
      ...
      >
        <div class="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.businessName ? 'border-red-500' : 'border-white/20'} text-white placeholder-white/50 focus:border-[#4dd3ff] focus:bg-white/8 transition-all"
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.name ? 'border-red-500' : 'border-white/20'} text-white placeholder-white/50 focus:border-[#4dd3ff] focus:bg-white/8 transition-all"
        ...
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.email ? 'border-red-500' : 'border-white/20'} text-white placeholder-white/50 focus:border-[#4dd3ff] focus:bg-white/8 transition-all"
          ...
          <div class="space-y-6 border-t border-white/10 pt-6">
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.phone ? 'border-red-500' : 'border-white/20'} text-white placeholder-white/50 focus:border-[#4dd3ff] focus:bg-white/8 transition-all"
            ...
            <div>
              ...
              <select
                ...
                class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.numberOfComputers ? 'border-red-500' : 'border-white/20'} text-white focus:border-[#4dd3ff] focus:bg-white/8 transition-all"
              >
            ...
            <div>
              ...
              <textarea
                ...
                class="w-full px-4 py-3 rounded-lg bg-white/5 border {errors.frustration ? 'border-red-500' : 'border-white/20'} text-white placeholder-white/50 focus:border-[#4dd3ff] focus:bg-white/8 transition-all resize-vertical"
        ...
        <div class="bg-white/5 rounded-lg p-4 text-center">
          ...
          <p class="text-xs text-white/60">
            I'll personally review your information and contact you within 24 hours to schedule your free 15-minute IT health check. 
            No spam, no pressure — just helpful advice tailored to your business.
          </p>
        </div>
      </form>
    </div>
