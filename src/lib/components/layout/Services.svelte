	...
	const services = [
		{
			...
			description:
				'Reliable IT support customized to fit the needs of your business. From helping with everyday tech problems to maintaining systems behind the scenes, I focus on keeping your operations running smoothly and securely.',
			color: 'bg-blue-50'
		},
		{
			...
			description:
				'Proactive system monitoring and automated patch management to secure your systems and minimize downtime before problems turn into headaches.',
			color: 'bg-green-50'
		},
		{
			...
			description:
				'Automated, secure backups both local and cloud-based so your critical data is safe, recoverable, and always within reach.',
			color: 'bg-yellow-50'
		},
		{
			...
			description:
				'Design and support for reliable wired and wireless networks, with fast troubleshooting to keep your team connected and productive.',
			color: 'bg-purple-50'
		},
		// {
		...
		// },
		{
			...
			description:
				'Get expert, practical advice on IT strategy, growth planning, and tool selection with solutions that match your size and goals. <br><br>I also do Custom-built PCs and servers, website setup and hosting, and more! Just ask.',
			color: 'bg-pink-50'
		}
	];
</script>
