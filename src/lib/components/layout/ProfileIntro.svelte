...
<section id="profile-intro" class="relative h-full flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
  <!-- Background gradient -->
  <div class="absolute inset-0 bg-gradient-to-b from-[#1a1a2e] to-[#0f0f1a]"></div>
  
  <!-- Centered glow effect -->
  <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-radial from-[#4dd3ff]/10 via-[#4dd36f]/10 to-transparent blur-[100px] opacity-60"></div>
      ...
      <div class="flex flex-col lg:flex-row items-center gap-12">
        ...
        >
          <div class="relative w-80 h-80 flex-shrink-0">
            ...
            <div class="absolute inset-0 rounded-full bg-conic-gradient animate-[rotate_10s_linear_infinite] p-[3px]">
              <div class="w-full h-full rounded-full bg-[#1a1a2e]"></div>
            </div>
            
            <!-- Glow effect -->
            <div class="absolute -inset-5 rounded-full bg-conic-gradient blur-[30px] opacity-50 animate-[rotate_10s_linear_infinite]"></div>
            
            <!-- Inner content with just the image -->
            <div class="absolute inset-[3px] rounded-full bg-[#1a1a2e] flex items-center justify-center p-8">
              <img 
              ...
              />
              {#if !imageLoaded}
                <div class="w-64 h-64 rounded-full bg-gradient-to-br from-[#4dd3ff]/20 to-[#4dd36f]/20 animate-pulse"></div>
              {/if}
            </div>
          </div>
        ...
        <div class="flex-1 text-center lg:text-left">
          ...
          >
            <p class="text-xl sm:text-2xl text-white/70 mb-4">
              I provide affordable IT support for small businesses that don't have a full-time IT person. For a flat monthly fee, I keep your computers secure, patched, and backed up.
            </p>
            
            <p class="text-xl sm:text-2xl text-white/70 mb-6">
              No confusing tech jargon, no surprise bills, just reliable IT support that lets you focus on what you do best: running your business.
            </p>
            
            <!-- Key benefits -->
            <div class="grid sm:grid-cols-2 gap-4 mt-8">
              <div class="flex items-start gap-3 hover-lift-item transition-all duration-300 hover:transform hover:translateY(-2px) cursor-default">
                <svg class="w-6 h-6 text-[#4dd36f] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
