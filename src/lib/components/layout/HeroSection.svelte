<script>
  ...
  onMount(() => {
    ...
    if (isVisible) {
      showTimeouts.push(setTimeout(() => { showHeadline = true; }, 100));
      showTimeouts.push(setTimeout(() => { showSubheadline = true; }, 300));
      showTimeouts.push(setTimeout(() => { showButtons = true; }, 500));
    }
  ...
  $: if (mounted && $currentSection !== -1 && !isVisible && (showHeadline || showSubheadline || showButtons)) {
...
<section class="relative h-full flex items-center py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
  ...
  <div class="absolute top-[20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-gradient-radial from-[#4dd36f]/30 to-transparent blur-[100px] animate-[float-glow_8s_ease-in-out_infinite] opacity-50"></div>
  <div class="absolute bottom-[20%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-radial from-[#4dd3ff]/30 to-transparent blur-[100px] animate-[float-glow-reverse_10s_ease-in-out_infinite] opacity-50"></div>
  
  <div class="relative z-10 max-w-6xl mx-auto transition-all duration-500" 
    ...
    <div class="text-center lg:text-left">
      ...
      <h1 
        ...
        style="opacity: {showHeadline ? 1 : 0}; transform: translate3d(0, 0, 0) scale({showHeadline ? 1 : 0.95}); will-change: transform, opacity;"
      >
      ...
      <p 
        ...
        style="opacity: {showSubheadline ? 1 : 0}; transform: translate3d(0, 0, 0) scale({showSubheadline ? 1 : 0.95}); transition-delay: 100ms; will-change: transform, opacity;"
      >
        For just <span class="text-[#4dd36f] font-semibold">$400/month</span>, I'll keep your computers secure, backed up, and running so you can focus on running your business, not fighting with tech.
      </p>
      
      <!-- CTA Buttons -->
      <div 
        class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start transition-all duration-600"
        style="opacity: {showButtons ? 1 : 0}; transform: translate3d(0, 0, 0) scale({showButtons ? 1 : 0.95}); transition-delay: 200ms; will-change: transform, opacity;"
      >
      ...
      <div 
        ...
        style="opacity: {showButtons ? 1 : 0}; transform: translate3d(0, 0, 0) scale({showButtons ? 1 : 0.95}); transition-delay: 300ms; will-change: transform, opacity;"
      >
